...
import { ShieldCheck, Award, Sparkles, Gift, Heart, Star, BookOpen, Clock, CheckCircle2 } from 'lucide-react';
      ...
      <main className="flex-grow">
        ...
        <section className="relative h-[80vh] flex items-center justify-center overflow-hidden border-b border-secondary-sand/30">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl space-y-6">
            ...
            >
              Our Heritage of <br/>
              <span className="text-primary-gold italic font-serif">Sweet Traditions</span>
            </motion.h1>
            ...
            >
              Crafting authentic Indian sweets with absolute purity, passion, and time-honored recipes for over three decades.
            </motion.p>
            ...
            >
              <Link to="/category/all">
                <Button size="lg" className="w-full sm:w-auto px-8 bg-primary hover:bg-primary/95 text-secondary-cream border-none shadow-xl">
                  Explore Collections
                </Button>
              </Link>
              <a href="#story">
                <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 border-primary-gold text-primary-gold hover:bg-primary-gold/10 bg-transparent">
                  Our Story
                </Button>
              </a>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-4">
                <span className="text-primary font-bold text-xs uppercase tracking-widest block">The Halwai Legacy</span>
                <Heading level={2} className="text-3xl md:text-5xl font-bold text-text-brown">
                  Handcrafted from the <br/>Heart of Connaught Place
                </Heading>
              </div>
              ...
              <p className="text-base text-text-brown/85 font-inter leading-relaxed">
                SSN Sudarshan Sweets began with a singular, passionate promise: to revive and preserve the purity of traditional Indian mithai making. In an era of mass factory production, we chose the slower, more authentic path of handcrafted batch kitchen preparation.
              </p>
              ...
              <blockquote className="border-l-4 border-primary pl-6 py-2 italic font-serif text-lg text-primary max-w-lg bg-primary/5 rounded-r-xl">
                "Our sweets are not just recipes of ingredients; they are emotional stories of family celebrations, passed down through generations of master sweet artisans."
              </blockquote>

              <p className="text-base text-text-brown/85 font-inter leading-relaxed">
                Every kaju katli we slice, every laddu we roll, and every namkeen mixture we spice contains three decades of passion. We remain committed to our heritage recipe standards, ensuring that when you open a box of Sudarshan sweets, you receive pure celebration.
              </p>
            </motion.div>
          </div>
        </section>
                ...
                {milestones.map((milestone, idx) => (
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2 pl-6 md:pl-0 md:text-right text-left md:even:text-left space-y-3">
                      <span className="font-playfair text-3xl font-bold text-primary block">{milestone.year}</span>
                      <h4 className="font-playfair text-xl font-bold text-text-brown">{milestone.title}</h4>
                      <p className="text-sm text-text-brown/70 font-inter leading-relaxed max-w-md md:ml-auto md:even:ml-0">{milestone.desc}</p>
                    </div>

                    {/* Image Column */}
                    <div className="w-full md:w-1/2">
                      <div className="aspect-[16/9] w-full rounded-2xl overflow-hidden shadow-md border border-secondary-sand/30">
                        <img src={milestone.img} alt={milestone.title} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                      </div>
                    </div>
                  </motion.div>
                ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((val, i) => (
              ...
              >
                ...
                <h4 className="font-playfair font-bold text-xl text-text-brown">{val.title}</h4>
                <p className="text-sm text-text-brown/70 font-inter leading-relaxed">{val.desc}</p>
              </motion.div>
            ))}
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <span className="text-primary-gold font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-1.5 mb-3">
                <Sparkles className="w-4 h-4 text-primary-gold" /> Handcrafted Batch Kitchen
              </span>
              <Heading level={2} className="text-3xl md:text-5xl font-bold text-white luxury-border-gold pb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeInUp} className="space-y-8">
                ...
                <p className="text-secondary-cream/80 text-base leading-relaxed font-inter">
                  We prepare our items daily in copper and brass vessels. Cooking sweets slowly allows ingredients like dry fruits, milk solids (khoya), and pure spices to fuse naturally, locking in moisture and maintaining rich textures.
                </p>

                <div className="space-y-6">
                  {craftSteps.map((step, idx) => (
                    <div key={idx} className="flex gap-4 items-start">
                      <span className="font-playfair text-primary-gold font-bold text-xl">{step.num}</span>
                      <div className="space-y-1">
                        <h5 className="font-playfair font-bold text-lg text-white">{step.title}</h5>
                        <p className="text-xs text-secondary-cream/60 font-inter leading-relaxed">{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              >
                <img 
                  src="https://images.pexels.com/photos/14424858/pexels-photo-14424858.jpeg" 
        ...
        <section className="py-24 container mx-auto px-4 md:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-6 mb-16">
            <span className="text-primary font-bold text-xs uppercase tracking-widest block">Sweetening Relationships</span>
            <Heading level={2} className="text-3xl md:text-5xl font-bold text-text-brown">
            ...
            <p className="text-text-brown/70 font-inter leading-relaxed">
              In India, sweets are not desserts. They are blessings, greetings, tokens of love, and pure heritage. We take pride in packaging joy for your life’s milestones.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <img 
                src="https://images.pexels.com/photos/14883448/pexels-photo-14883448.jpeg" 
                alt="Festive Gifting" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              />
              <div className="absolute bottom-6 left-6 right-6 z-20 text-left space-y-2">
                <span className="text-[10px] text-primary-gold uppercase font-bold tracking-wider">Festivals</span>
                <h4 className="font-playfair text-xl font-bold text-white">Diwali & Rakhi Hampers</h4>
                <p className="text-xs text-white/70 font-inter font-light">Custom royal platters designed to spread prosperity and light to families.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-t from-text-brown/95 via-text-brown/30 to-transparent z-10"></div>
              <img 
                src="https://images.pexels.com/photos/9500201/pexels-photo-9500201.jpeg" 
                alt="Royal Weddings" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              />
              <div className="absolute bottom-6 left-6 right-6 z-20 text-left space-y-2">
                <span className="text-[10px] text-primary-gold uppercase font-bold tracking-wider">Weddings</span>
                <h4 className="font-playfair text-xl font-bold text-white">Royal Shagun Boxes</h4>
                <p className="text-xs text-white/70 font-inter font-light">Exquisite sweets boxes to welcome guests and celebrate sacred wedding vows.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              />
              <div className="absolute bottom-6 left-6 right-6 z-20 text-left space-y-2">
                <span className="text-[10px] text-primary-gold uppercase font-bold tracking-wider">Corporate</span>
                <h4 className="font-playfair text-xl font-bold text-white">Premium B2B Gifting</h4>
                <p className="text-xs text-white/70 font-inter font-light">Custom branded premium wooden boxes and velvet packages for key partnerships.</p>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeInUp} className="space-y-6">
                <span className="text-primary font-bold text-xs uppercase tracking-widest block">Quality Assured</span>
                <Heading level={2} className="text-3xl md:text-5xl font-bold text-text-brown">
                  Our Purity Promise
                </Heading>
                <div className="w-16 h-[2px] bg-primary-gold"></div>
                <p className="text-base text-text-brown/85 font-inter leading-relaxed">
                  Purity is not a slogan for us; it is our brand foundation. We test milk parameters daily in our in-house lab, work only in sterile kitchens, and guarantee 100% vegetarian ingredients.
                </p>
                <div className="grid grid-cols-2 gap-6 pt-4">
                  <div className="p-4 bg-white border border-secondary-sand/35 rounded-xl">
                    <p className="font-playfair font-bold text-primary text-2xl">100%</p>
                    <p className="text-xs text-text-brown/60 uppercase font-semibold font-inter tracking-wider">Desi Ghee</p>
                  </div>
                  <div className="p-4 bg-white border border-secondary-sand/35 rounded-xl">
                    <p className="font-playfair font-bold text-primary text-2xl">Zero</p>
                    <p className="text-xs text-text-brown/60 uppercase font-semibold font-inter tracking-wider">Preservatives</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div {...fadeInUp} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-secondary-sand/20 shadow-sm text-left">
                  ...
                  <h4 className="font-playfair font-bold text-lg text-text-brown mb-1">ISO Certified kitchens</h4>
                  <p className="text-xs text-text-brown/60 font-inter leading-relaxed">Top standards in safety and temperature control cooking environments.</p>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-secondary-sand/20 shadow-sm text-left">
                  <Sparkles className="w-8 h-8 text-primary mb-3" />
                  <h4 className="font-playfair font-bold text-lg text-text-brown mb-1">Freshly Made Daily</h4>
                  <p className="text-xs text-text-brown/60 font-inter leading-relaxed">We batch cook every morning, ensuring zero shelf-aging of confections.</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-24 container mx-auto px-4 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-primary font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-1.5 mb-3">
              <Star className="w-4 h-4 text-primary-gold fill-primary-gold" /> Kirdaar Testimonials
            </span>
            <Heading level={2} className="text-3xl md:text-5xl font-bold text-text-brown luxury-border-gold pb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="italic text-sm text-text-brown/80 font-inter leading-relaxed">
                "The Kaju Katli from Sudarshan Sweets is pure nostalgia. It melts effortlessly, and the richness of pure ghee is so evident. Our family has been buying since 2005!"
              </p>
              <div>
                <p className="font-playfair font-bold text-text-brown">Devendra Sharma</p>
                <p className="text-[10px] text-primary-gold uppercase tracking-wider font-semibold font-inter mt-0.5">Delhi Legacy Client</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="italic text-sm text-text-brown/80 font-inter leading-relaxed">
                "For our daughter's wedding, we ordered customized velvet boxes. Our guests were absolutely charmed by both the packaging design and the divine Motichoor Ladoos."
              </p>
              <div>
                <p className="font-playfair font-bold text-text-brown">Kiran Kapoor</p>
                <p className="text-[10px] text-primary-gold uppercase tracking-wider font-semibold font-inter mt-0.5">Gurugram Bride's Mother</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="italic text-sm text-text-brown/80 font-inter leading-relaxed">
                "Finding organic, low-sugar authentic sweets is difficult. Their sugar-free range made with organic dates and saffron is exceptional. Highly recommend for pure gifting."
              </p>
              <div>
                <p className="font-playfair font-bold text-text-brown">Rohan Malhotra</p>
                <p className="text-[10px] text-primary-gold uppercase tracking-wider font-semibold font-inter mt-0.5">Corporate Gifting Partner</p>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="relative py-28 overflow-hidden border-t border-secondary-sand/30">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl space-y-8">
            <Heading level={2} className="text-3xl md:text-5xl font-bold text-secondary-cream leading-tight">
              ...
              <span className="text-primary-gold italic font-serif">Authentic Indian Sweetness</span>
            </Heading>
            <p className="text-sm md:text-base text-secondary-cream/70 font-inter max-w-xl mx-auto leading-relaxed">
              Order fresh handmade cow ghee confections, dry fruit boxes, or customized corporate and wedding hampers delivered vacuum-sealed across India.
            </p>
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center pt-2">
              <Link to="/category/all" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto px-8 bg-primary-gold hover:bg-white hover:text-primary text-[#150B07] border-none font-bold shadow-lg">
                  Shop Premium Sweets
                </Button>
              </Link>
              <Link to="/category/festive" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 border-secondary-cream text-secondary-cream hover:bg-white/10 bg-transparent font-bold">
